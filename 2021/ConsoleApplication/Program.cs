...
namespace Console
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                case "1":
                    new Day1(int.Parse(part), int.Parse(day));
                    break;
                case "2":
                    new Day2(int.Parse(part), int.Parse(day));
                    break;
                case "3":
                    new Day3(int.Parse(part), int.Parse(day));
                    break;
                case "4":
                    new Day4(int.Parse(part), int.Parse(day));
                    break;
                case "5":
                    new Day5(int.Parse(part), int.Parse(day));
                    break;
                case "6":
                    new Day6(int.Parse(part), int.Parse(day));
                    break;
                case "7":
                    new Day7(int.Parse(part), int.Parse(day));
                    break;
                case "8":
                    new Day8(int.Parse(part), int.Parse(day));
                    break;
                case "9":
                    new Day9(int.Parse(part), int.Parse(day));
                    break;
            }
        }

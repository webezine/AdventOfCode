        ...
        static void Main(string[] args)
        {
            ...
            switch (day)
            {
                ...
                case "05":
                    ...
                    break;
                case "06":
                    new Day06(int.Parse(part), day);
                    break;
                case "07":
                    new Day07(int.Parse(part), day);
                    break;
                case "08":
                    new Day08(int.Parse(part), day);
                    break;
                case "09":
                    new Day09(int.Parse(part), day);
                    break;
                case "10":
                    new Day10(int.Parse(part), day);
                    break;
                case "11":
                    new Day11(int.Parse(part), day);
                    break;
                case "12":
                    new Day12(int.Parse(part), day);
                    break;
                case "13":
                    new Day13(int.Parse(part), day);
                    break;
            }
        }
